...
#
# Created: Mon Jan 28 16:07:50 2019
...
class Ui_searchDialog(object):
    def setupUi(self, searchDialog):
        ...
        self.searchButton.setGeometry(QtCore.QRect(50, 400, 99, 27))
    ...
    def retranslateUi(self, searchDialog):
        ...
        self.mainTable.horizontalHeaderItem(3).setText(QtWidgets.QApplication.translate("searchDialog", "City", None, -1))
        self.mainTable.horizontalHeaderItem(4).setText(QtWidgets.QApplication.translate("searchDialog", "State", None, -1))
        self.mainTable.horizontalHeaderItem(5).setText(QtWidgets.QApplication.translate("searchDialog", "Zip Code", None, -1))
